...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-06-2024 a las 05:46:20
...
CREATE TABLE `facturas` (
  ...
  `idforma` bigint(20) UNSIGNED NOT NULL,
...
(5, 'Pago móvil'),
(6, 'Pago en línea'),
(7, 'Pago contra entrega'),
(8, 'Financiamiento'),
(9, 'Bitcoin/criptomonedas');
...
CREATE TABLE `users` (
  ...
  `idperfil` bigint(20) UNSIGNED NOT NULL DEFAULT 3,
